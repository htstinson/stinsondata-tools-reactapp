...
import { PermissionForm } from './RolePermissionForm';
    ...
    <div className="px-4 sm:px-0">
      <div className="mb-4 flex justify-between customers-center">
        ...
        <div className="flex customers-center space-x-4">
          <Button onClick={handleCreate} themeColor="primary">Create New Role-Permission</Button>
      ...
      {loading ? (
        ...
        >
          <GridColumn field="v_role_name" title="Role" />
          <GridColumn field="v_permission_name" title="Permission" />
          <GridColumn field="v_object_name" title="Object" />
      ...
      {showDialog && (
        <Dialog title={editPermission ? "Edit Role Permission" : "Create New Role Permission"} onClose={() => setShowDialog(false)}>
